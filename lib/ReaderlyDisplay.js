...
(function(root, displayFactory) {  // root is usually `window`
	...
	<div id="__rdly_bar" class="__rdly-main-section">\
		...
		<div class="__rdly-bar-section __rdly-bar-right2">\
			<label for="__rdly_halvespeed_input">1/2</label>\
	...
	<div id="__rdly_below_bar" class="__rdly-main-section __rdly-hidden"></div>\
        ...
        rDis.show = function() {
            ...
            $iframe[0].contentDocument.addEventListener('keydown', keybinds);
            $iframe[0].contentDocument.body.addEventListener('keydown', keybinds);
        ...
        rDis.hide = function() {
            ...
            $iframe[0].contentDocument.removeEventListener('keydown', keybinds);
            $iframe[0].contentDocument.body.removeEventListener('keydown', keybinds);
        ...
        rDis.toggleHalfSpeed = function(event) {
            var modifier = event.target.checked ? 2 : 1;
            settings.set('delayModifier', modifier);
        };

        // =========== INITIALIZE =========== \\

        var isSpeedHalved = settings.isModifier.bind(null, 2);
